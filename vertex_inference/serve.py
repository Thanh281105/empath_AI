...
model = None
tokenizer = None
model_id = os.getenv("MODEL_ID", "Thanh28105/empathAI-llama3.1-8b")
...
def chat_completions():
    ...
    try:
        ...
        response = {
            ...
            "created": int(torch.cuda.Event(enable_timing=False).elapsed_time(torch.cuda.Event(enable_timing=False))),
            "model": model_id,
            "choices": [{
                "index": 0,
                "message": {
